...
contract DEX {
    ...
    function ethToToken() public payable returns (uint256 tokenOutput) {
        ...
        require(token.transfer(msg.sender, tokenOutput), "ethToToken: revert in transfer");
    ...
    function tokenToEth(uint256 tokenInput) public returns (uint256 ethOutput) {
        ...
        require(token.transferFrom(msg.sender, address(this), tokenInput), "tokenToEth: revert in transfer");
    ...
    function withdraw(uint256 amount) public returns (uint256 ethAmount, uint256 tokenAmount) {
        ...
        require(sent, "withdraw: revert in returning eth");
        require(token.transfer(msg.sender, tokenAmount), "withdraw: revert in returning token");
