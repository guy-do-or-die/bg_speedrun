...
const deployedContracts = {
  ...
  11155111: {
    Corn: {
      address: "0x01876DDAAb4057c0625A05B5643502d2b80a59e1",
      abi: [
        {
          inputs: [],
          stateMutability: "nonpayable",
      ...
      deployedOnBlock: 9913999,
    },
    CornDEX: {
      address: "0xCbdd1b6163861e93213303984c3BCc3f9D2f2561",
      abi: [
        {
          inputs: [
            {
      ...
      inheritedFunctions: {},
      deployedOnBlock: 9914000,
    },
    Lending: {
      address: "0x58C982CE38fB172eD14110CA293eD3ECAc667Ac2",
      abi: [
        {
          inputs: [
            {
      ...
      deployedOnBlock: 9914001,
    },
    MovePrice: {
      address: "0x6fC0395176769737ACC01dA603fdeeD6B51BD5FD",
      abi: [
        {
          inputs: [
            {
